...
public class CmoncolRegistries {
        ...
        // Registry Keys
        private static final ResourceKey<Registry<JobEntry>> JOB_KEY = ResourceKey
                        .createRegistryKey(ResourceLocation.fromNamespaceAndPath("minecolonies", "jobs"));
        private static final ResourceKey<Registry<BuildingEntry>> BLD_KEY = ResourceKey
                        .createRegistryKey(ResourceLocation.fromNamespaceAndPath("minecolonies", "buildings"));
        ...
        public static void onRegister(RegisterEvent event) {
                ...
                if (event.getRegistryKey().equals(JOB_KEY)) {
                        ResourceLocation rancherLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "rancher");
                        RANCHER_JOB_ENTRY = new JobEntry.Builder().setRegistryName(rancherLoc)
                                        .setJobProducer(RancherJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                        event.register(JOB_KEY, rancherLoc, () -> RANCHER_JOB_ENTRY);

                        ResourceLocation attendantLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "attendant");
                        ATTENDANT_JOB_ENTRY = new JobEntry.Builder().setRegistryName(attendantLoc)
                                        .setJobProducer(AttendantJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                        event.register(JOB_KEY, attendantLoc, () -> ATTENDANT_JOB_ENTRY);

                        ResourceLocation evTrainerLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "ev_trainer");
                        EV_TRAINER_JOB_ENTRY = new JobEntry.Builder().setRegistryName(evTrainerLoc)
                                        .setJobProducer(EVTrainerJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                        event.register(JOB_KEY, evTrainerLoc, () -> EV_TRAINER_JOB_ENTRY);

                        ResourceLocation harvLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "harvester");
                        HARVESTER_JOB_ENTRY = new JobEntry.Builder().setRegistryName(harvLoc)
                                        .setJobProducer(HarvesterJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                        event.register(JOB_KEY, harvLoc, () -> HARVESTER_JOB_ENTRY);

                        ResourceLocation pokeLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "pokeball_workshop");
                        POKEBALLWORKSHOP_JOB_ENTRY = new JobEntry.Builder().setRegistryName(pokeLoc)
                                        .setJobProducer(PokeballWorkshopJob::new)
                                        .setJobViewProducer(() -> CrafterJobView::new).createJobEntry();
                        event.register(JOB_KEY, pokeLoc, () -> POKEBALLWORKSHOP_JOB_ENTRY);

                        ResourceLocation nurseLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "nurse");
                        NURSE_JOB_ENTRY = new JobEntry.Builder().setRegistryName(nurseLoc).setJobProducer(NurseJob::new)
                                        .setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
                        event.register(JOB_KEY, nurseLoc, () -> NURSE_JOB_ENTRY);

                        ResourceLocation pguardLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "pokemon_guard");
                        POKEMON_GUARD_JOB_ENTRY = new JobEntry.Builder().setRegistryName(pguardLoc)
                                        .setJobProducer(PokemonGuardJob::new)
                                        .setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
                        event.register(JOB_KEY, pguardLoc, () -> POKEMON_GUARD_JOB_ENTRY);

                        ResourceLocation sciLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "science_lab");
                        SCIENCELAB_JOB_ENTRY = new JobEntry.Builder().setRegistryName(sciLoc)
                                        .setJobProducer(ScientistJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                        event.register(JOB_KEY, sciLoc, () -> SCIENCELAB_JOB_ENTRY);

                        ResourceLocation gymJobLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "gym");
                        GYM_JOB_ENTRY = new JobEntry.Builder().setRegistryName(gymJobLoc).setJobProducer(GymJob::new)
                                        .setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
                        event.register(JOB_KEY, gymJobLoc, () -> GYM_JOB_ENTRY);

                        ResourceLocation wonderTraderLoc = ResourceLocation
                                        .fromNamespaceAndPath(CobblemonColonies.MODID, "wonder_trader");
                        WONDER_TRADER_JOB_ENTRY = new JobEntry.Builder().setRegistryName(wonderTraderLoc)
                                        .setJobProducer(WonderTraderJob::new)
                                        .setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
                        event.register(JOB_KEY, wonderTraderLoc, () -> WONDER_TRADER_JOB_ENTRY);

                        ResourceLocation pokeMerchantLoc = ResourceLocation
                                        .fromNamespaceAndPath(CobblemonColonies.MODID, "pokemerchant");
                        POKEMERCHANT_JOB_ENTRY = new JobEntry.Builder().setRegistryName(pokeMerchantLoc)
                                        .setJobProducer(PokeMerchantJob::new)
                                        .setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
                        event.register(JOB_KEY, pokeMerchantLoc, () -> POKEMERCHANT_JOB_ENTRY);

                        ResourceLocation rangerLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "ranger");
                        RANGER_JOB_ENTRY = new JobEntry.Builder().setRegistryName(rangerLoc)
                                        .setJobProducer(RangerJob::new).setJobViewProducer(() -> DefaultJobView::new)
                                        .createJobEntry();
                ...
                if (event.getRegistryKey().equals(BLD_KEY)) {
                        RANCHER_WORK = new BuildingEntry.ModuleProducer<>(
                                        "rancher_work", () -> new WorkerBuildingModule(RANCHER_JOB_ENTRY, Skill.Stamina,
                                                        Skill.Agility, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        ATTENDANT_WORK = new BuildingEntry.ModuleProducer<>(
                                        "attendant_work", () -> new WorkerBuildingModule(ATTENDANT_JOB_ENTRY,
                                                        Skill.Mana, Skill.Knowledge, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        EV_TRAINER_WORK = new BuildingEntry.ModuleProducer<>("ev_trainer_work",
                                        () -> new WorkerBuildingModule(EV_TRAINER_JOB_ENTRY, Skill.Athletics,
                                                        Skill.Strength, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        PASTURE_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("pasture_proxy",
                                        PastureProxyModule::new, () -> PastureProxyModuleView::new);
                        DAYCARE_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("daycare_proxy",
                                        DaycareProxyModule::new, () -> DaycareProxyModuleView::new);
                        TRAINER_ACADAMY_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("acadamy_proxy",
                                        TrainerAcadamyProxyModule::new, () -> TrainerAcadamyProxyModuleView::new);
                        SCIENCELAB_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("sciencelab_proxy",
                                        ScienceLabProxyModule::new, () -> ScienceLabProxyModuleView::new);
                        WONDER_TRADE_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("wonder_trade_proxy",
                                        WonderTradeProxyModule::new, () -> WonderTradeProxyModuleView::new);
                        POKEMART_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("pokemart_proxy",
                                        PokemartProxyModule::new, () -> PokemartProxyModuleView::new);
                        SCIENCELAB_JOURNAL_MODULE = new BuildingEntry.ModuleProducer<>("sciencelab_journal",
                                        ScienceLabJournalProxyModule::new, () -> ScienceLabJournalProxyModuleView::new);
                        HARVESTER_WORK = new BuildingEntry.ModuleProducer<>("harvester_work",
                                        () -> new WorkerBuildingModule(HARVESTER_JOB_ENTRY, Skill.Agility,
                                                        Skill.Stamina, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKEBALLWORKSHOP_WORK = new BuildingEntry.ModuleProducer<>("pokeballworkshop_work",
                                        () -> new com.minecolonies.core.colony.buildings.modules.CraftingWorkerBuildingModule(
                                                        POKEBALLWORKSHOP_JOB_ENTRY, Skill.Dexterity, Skill.Agility,
                                                        false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKEBALLWORKSHOP_RECIPES = new BuildingEntry.ModuleProducer<>("pokeballworkshop_recipes",
                                        () -> new PokeballWorkshopBuilding.CraftingModule(POKEBALLWORKSHOP_JOB_ENTRY),
                                        () -> PokeballWorkshopBuildingView.PokeballCraftingModuleView::new);
                        SCIENCELAB_WORK = new BuildingEntry.ModuleProducer<>("sciencelab_work",
                                        () -> new WorkerBuildingModule(SCIENCELAB_JOB_ENTRY, Skill.Intelligence,
                                                        Skill.Knowledge, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKECENTER_WORK = new BuildingEntry.ModuleProducer<>("pokecenter_work",
                                        () -> new WorkerBuildingModule(NURSE_JOB_ENTRY, Skill.Intelligence,
                                                        Skill.Adaptability, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKEMON_GUARD_WORK = new BuildingEntry.ModuleProducer<>("worker",
                                        () -> new WorkerBuildingModule(POKEMON_GUARD_JOB_ENTRY, Skill.Athletics,
                                                        Skill.Strength, false, b -> {
                                                                int lvl = b.getBuildingLevel();
                                                                if (lvl >= 5)
                                                                        return 3;
                                                                if (lvl >= 3)
                                                                        return 2;
                                        ...
                                        () -> WorkerBuildingModuleView::new);
                        GYM_WORK = new BuildingEntry.ModuleProducer<>(
                                        "gym_work", () -> new WorkerBuildingModule(GYM_JOB_ENTRY, Skill.Knowledge,
                                                        Skill.Mana, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        WONDER_TRADER_WORK = new BuildingEntry.ModuleProducer<>("wonder_trader_work",
                                        () -> new WorkerBuildingModule(WONDER_TRADER_JOB_ENTRY, Skill.Mana,
                                                        Skill.Knowledge, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKEMERCHANT_WORK = new BuildingEntry.ModuleProducer<>("pokemerchant_work",
                                        () -> new WorkerBuildingModule(POKEMERCHANT_JOB_ENTRY, Skill.Adaptability,
                                                        Skill.Intelligence, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        RANGER_WORK = new BuildingEntry.ModuleProducer<>(
                                        "ranger_work", () -> new WorkerBuildingModule(RANGER_JOB_ENTRY, Skill.Agility,
                                                        Skill.Athletics, false, b -> 1),
                                        () -> WorkerBuildingModuleView::new);
                        POKEMON_GUARD_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("guard_proxy",
                                        PokemonGuardProxyModule::new, () -> PokemonGuardProxyModuleView::new);

                        // REGISTER BUILDINGS
                        ResourceLocation pastLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_pasture");
                        ...
                        ResourceLocation dayLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_daycare");
                        ...
                        ResourceLocation academyLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_traineracademy");
                        ...
                        ResourceLocation pbBldLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_pokeballworkshop");
                        ...
                        ResourceLocation centerLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_pokecenter");
                        ...
                        ResourceLocation pguardBldLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_pokemon_guard");
                        ...
                        ResourceLocation gymBldLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_gym");
                        ...
                        ResourceLocation wonderTradeBldLoc = ResourceLocation
                                        .fromNamespaceAndPath(CobblemonColonies.MODID, "colony_wonder_trade");
                        ...
                        ResourceLocation pokemartBldLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_pokemart");
                        ...
                        ResourceLocation rangerBldLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID,
                                        "colony_ranger");
