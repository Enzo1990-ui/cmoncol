...
public class CmoncolRegistries {
    ...
    public static void onRegister(RegisterEvent event) {
        ...
        if (event.getRegistryKey().equals(JOB_KEY)) {
            ...
            POKEBALLWORKSHOP_JOB_ENTRY = new JobEntry.Builder().setRegistryName(pokeLoc).setJobProducer(PokeballWorkshopJob::new).setJobViewProducer(() -> DefaultJobView::new).createJobEntry();
        ...
        if (event.getRegistryKey().equals(BLD_KEY)) {
            ...
            PASTURE_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("pasture_proxy", () -> new PastureProxyModule(), () -> PastureProxyModuleView::new);
            DAYCARE_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("daycare_proxy", () -> new DaycareProxyModule(), () -> DaycareProxyModuleView::new);
            TRAINER_ACADAMY_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("acadamy_proxy", () -> new TrainerAcadamyProxyModule(), () -> TrainerAcadamyProxyModuleView::new);
			SCIENCELAB_PROXY_MODULE = new BuildingEntry.ModuleProducer<>("sciencelab_proxy", () -> new ScienceLabProxyModule(), () -> ScienceLabProxyModuleView::new);
			SCIENCELAB_JOURNAL_MODULE = new BuildingEntry.ModuleProducer<>("sciencelab_journal", () -> new ScienceLabJournalProxyModule(), () -> ScienceLabJournalProxyModuleView::new);
            ...
            POKEBALLWORKSHOP_WORK = new BuildingEntry.ModuleProducer<>("pokeballworkshop_work", () -> new WorkerBuildingModule(POKEBALLWORKSHOP_JOB_ENTRY, Skill.Dexterity, Skill.Agility, false, b -> 1), () -> WorkerBuildingModuleView::new);
            ...
            ResourceLocation pokeLoc = ResourceLocation.fromNamespaceAndPath(CobblemonColonies.MODID, "colony_pokeballworkshop");
            POKEBALLWORKSHOP_BUILDING_ENTRY = new BuildingEntry.Builder()
                .setRegistryName(pokeLoc)
                ...
                .addBuildingModuleProducer(BuildingModules.MIN_STOCK)
                .createBuildingEntry();
            event.register(BLD_KEY, pokeLoc, () -> POKEBALLWORKSHOP_BUILDING_ENTRY);
